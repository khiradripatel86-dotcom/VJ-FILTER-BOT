...
# Bot information
SESSION = environ.get('SESSION', 'Temramoviesbot')
API_ID = int(environ.get('API_ID', '35790707'))
API_HASH = environ.get('API_HASH', '44753bcac8911c81028f009377368330')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7330253257').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003527774935'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003865059298').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://khiradripatel86:Temra6600@temratvmovie.nawpkh6.mongodb.net/?appName=Temratvmovie")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "temramoviesbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'temramoviescollections')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/temramovies')
